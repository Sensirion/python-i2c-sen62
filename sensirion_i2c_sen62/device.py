...
from sensirion_i2c_sen62.commands import (ActivateShtHeater, DeviceReset, DeviceStatus, GetDataReady, GetProductName,
                                          GetProductType, GetSerialNumber, GetShtHeaterMeasurements, GetVersion,
...
from sensirion_i2c_sen62.result_types import (SignalDividedBy10Uint16, SignalHumidity, SignalTemperature)
...
class Sen62Device(Sen62DeviceBase):
    ...
    def read_measured_values(self):
        ...
        (mass_concentration_pm1p0_raw, mass_concentration_pm2p5_raw, mass_concentration_pm4p0_raw,
         ...
         ) = self.sen62.read_measured_values_as_integers()
        return (SignalDividedBy10Uint16(mass_concentration_pm1p0_raw),
                ...
                SignalTemperature(temperature_raw))
