...
1. Install the SEN62 driver and all required packages as described in :ref:`Installation`.
...
4. Connect the SEN62 sensor to the SEK-SensorBridge
5. Run the example script from the root of the repository.
   ...
   .. sourcecode:: bash
        ...
        python examples/example_usage_sensorbridge_sen62.py --serial-port <your COM port>
...
.. literalinclude:: ../examples/example_usage_sensorbridge_sen62.py
    :language: python
...
1. Install the SEN62 driver and all required packages as described in :ref:`Installation`.
2. Connect the SEN62 sensor to the I²C port of your system (for example to the I²C port 1 of a Raspberry Pi).
3. Run the example script from the root of the repository.
   ...
   .. sourcecode:: bash
      ...
      python examples/example_usage_linux_sen62.py --i2c-port <your I2C port>

Example script
~~~~~~~~~~~~~~

.. literalinclude:: ../examples/example_usage_linux_sen62.py
    :language: python
